...
function Banner() {
  return (
    <div
      className="relative isolate mt-14 bg-cover bg-center object-cover w-full py-40 md:py-48 lg:py-56 bg-no-repeat transform-gpu items-center justify-center bg-blend-multiply"
      style={{
